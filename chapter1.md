...
2014年Stratosphere代码的一个分支捐献给Apache软件基金会作为一个孵化项目，该系统的核心开发人员构成了其初始的commiter。在这之后很短的时间，许多初始的commiter离开大学并创办了一家名为data Art公司来商业化Flink。在孵化阶段，由于与一个不相干的项目存在混淆，这个项目不得不改变原来Stratosphere的名字。Flink被选中来代表这个流和批处理系统：在德语中，flink有快速或敏捷之意。图标选择了一个多彩的松鼠，因为松鼠行动快速而敏捷--宛如柏林的松鼠--一个迷人的红棕色的外表，正如你在图 1-3所见的那样。
